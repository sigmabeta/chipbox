...
class BrowseByArtistScreenshots(
    ...
    @Test
    fun browseByArtistScreen() {
        paparazzi.unsafeUpdateConfig(deviceConfig = deviceConfig)
        paparazzi.snapshot {
            BrowseByArtist(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }

    @Test
    fun browseByArtistScreenLoading() {
        paparazzi.unsafeUpdateConfig(deviceConfig = deviceConfig)
        paparazzi.snapshot {
            BrowseByArtistLoading(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }
