...
class BrowseAllTracksScreenshots(
    ...
    @Test
    fun browseAllTracksScreen() {
        paparazzi.unsafeUpdateConfig(deviceConfig = deviceConfig)
        paparazzi.snapshot {
            BrowseAllTracks(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }

    @Test
    fun browseAllTracksScreenLoading() {
        paparazzi.unsafeUpdateConfig(deviceConfig = deviceConfig)
        paparazzi.snapshot {
            BrowseAllTracksLoading(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }
