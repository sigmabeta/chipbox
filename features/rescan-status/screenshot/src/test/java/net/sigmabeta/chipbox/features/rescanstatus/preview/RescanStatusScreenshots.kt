...
class RescanStatusScreenshots(
    ...
    fun rescanStatusScreen() {
        ...
        paparazzi.snapshot {
            RescanStatus(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }

    @Test
    fun rescanStatusScreenIdle() {
        paparazzi.unsafeUpdateConfig(deviceConfig = deviceConfig)
        paparazzi.snapshot {
            RescanStatusIdle(syntheticWidthClass = deviceConfig.toWidthClass())
        }
    }
