...
#define CHIPBOX_JNI_CLASS Java_net_sigmabeta_chipbox_player_emulators_usf_UsfEmulator_
#include <chipbox_jni_bridge.h>

extern "C" {

JNIEXPORT void JNICALL
Java_net_sigmabeta_chipbox_player_emulators_usf_UsfEmulator_loadTrackInternalNative(
        JNIEnv *env,
        jobject thiz,
