...
// Android-only companion to `:ssfeal`. AGP's KMP library plugin has no externalNativeBuild
...
// same cbox/native/ssf tree into apps/jvm/libs instead. ("native" is a Java keyword, so the
// namespace uses "nativelib".)
android {
    namespace = "net.sigmabeta.chipbox.player.emulators.ssf.nativelib"
