...
/*
** Direct IOP RAM base (2 MB). For the HLE engine.
*/
void *EMU_CALL iop_get_ram(void *state);

/*
** Owning PSX_STATE (HLE PS2 loader -> VFS).
*/
void *EMU_CALL iop_get_psx_state(void *state);

/*
** Request a clean halt from outside the CPU loop (HLE).
*/
