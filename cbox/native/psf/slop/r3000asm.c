...
static const char *assemble(uint32 pc, const char *text, uint32 *ins) {
    ...
    if (alphacompare(text, "jalr"))
        return assemblepatterns("S/D,S", pc, text + 4, ins, 0x09 | (0x1F << 11));
    ...
    if (alphacompare(text, "bltz"))
        return assemblepatterns("S,B", pc, text + 4, ins, (0x01 << 26) | (0x00 << 16));
    if (alphacompare(text, "bgez"))
        return assemblepatterns("S,B", pc, text + 4, ins, (0x01 << 26) | (0x01 << 16));
    if (alphacompare(text, "bltzal"))
        return assemblepatterns("S,B", pc, text + 6, ins, (0x01 << 26) | (0x10 << 16));
    if (alphacompare(text, "bgezal"))
        return assemblepatterns("S,B", pc, text + 6, ins, (0x01 << 26) | (0x11 << 16));
    ...
    if (alphacompare(text, "beq"))
        return assemblepatterns("S,T,B", pc, text + 3, ins, (0x04 << 26));
    if (alphacompare(text, "bne"))
        return assemblepatterns("S,T,B", pc, text + 3, ins, (0x05 << 26));
    ...
    if (alphacompare(text, "addi"))
        return assemblepatterns("G,I/T,S,I", pc, text + 4, ins, (0x08 << 26));
    if (alphacompare(text, "addiu"))
        return assemblepatterns("G,I/T,S,I", pc, text + 5, ins, (0x09 << 26));
    if (alphacompare(text, "slti"))
        return assemblepatterns("T,S,I", pc, text + 4, ins, (0x0A << 26));
    if (alphacompare(text, "sltiu"))
        return assemblepatterns("T,S,I", pc, text + 5, ins, (0x0B << 26));

    if (alphacompare(text, "andi"))
        return assemblepatterns("G,I/T,S,I", pc, text + 4, ins, (0x0C << 26));
    if (alphacompare(text, "ori"))
        return assemblepatterns("G,I/T,S,I", pc, text + 3, ins, (0x0D << 26));
    if (alphacompare(text, "xori"))
        return assemblepatterns("G,I/T,S,I", pc, text + 4, ins, (0x0E << 26));
    if (alphacompare(text, "lui")) return assemblepatterns("T,I", pc, text + 3, ins, (0x0F << 26));

    if (alphacompare(text, "mfc0"))
        return assemblepatterns("T,C", pc, text + 4, ins, (0x10 << 26) | (0x00 << 21));
    if (alphacompare(text, "mtc0"))
        return assemblepatterns("T,C", pc, text + 4, ins, (0x10 << 26) | (0x04 << 21));
    if (alphacompare(text, "rfe"))
        return assemblepatterns("", pc, text + 3, ins, (0x10 << 26) | (0x10 << 21));

    if (alphacompare(text, "lb"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 2, ins, (uint32) (0x20 << 26));
    if (alphacompare(text, "lh"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 2, ins, (uint32) (0x21 << 26));
    if (alphacompare(text, "lw"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 2, ins, (uint32) (0x23 << 26));
    if (alphacompare(text, "lbu"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 3, ins, (uint32) (0x24 << 26));
    if (alphacompare(text, "lhu"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 3, ins, (uint32) (0x25 << 26));
    if (alphacompare(text, "sb"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 2, ins, (uint32) (0x28 << 26));
    if (alphacompare(text, "sh"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 2, ins, (uint32) (0x29 << 26));
    if (alphacompare(text, "sw"))
        return assemblepatterns("T,(S)/T,I(S)", pc, text + 2, ins, (uint32) (0x2B << 26));
