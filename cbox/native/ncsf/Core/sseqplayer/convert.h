...
#include <typeinfo>
#include <locale>
// chipbox: upstream pulled in a vendored codecvt/wstring_convert for pre-C++11 libraries; on
// modern libc++ (NDK) and libstdc++ (host) those collide with the standard facets, so always
// use the standard <codecvt>. (The wide-string helpers below are unused by the player anyway.)
#include <codecvt>
#include <vector>
#include <cmath>
