...
// chipbox: the upstream build defined std::codecvt<char16_t/char32_t> facet ids here for
// pre-C++11 standard libraries that lacked them. Modern libc++ (Android NDK) and libstdc++
// (host JVM build) both provide these, so defining them again is a redefinition error. Removed.
