...
typedef struct mips_cpu_context MIPS_CPU_CONTEXT;

typedef void genf(void *);

typedef int offs_t;

#define cpu_readop32(pc) program_read_dword_32le(mipscpu->psx, pc)
#define change_pc(pc)                                                                    \
...
typedef void        (*write16_handler)(void *, UNUSEDARG offs_t offset, UNUSEDARG int16 data,
                                       UNUSEDARG int16 mem_mask);

typedef int32        (*read32_handler)(void *, UNUSEDARG offs_t offset, UNUSEDARG int32 mem_mask);

typedef void        (*write32_handler)(void *, UNUSEDARG offs_t offset, UNUSEDARG int32 data,
                                       UNUSEDARG int32 mem_mask);

typedef int64        (*read64_handler)(void *, UNUSEDARG offs_t offset, UNUSEDARG int64 mem_mask);

typedef void        (*write64_handler)(void *, UNUSEDARG offs_t offset, UNUSEDARG int64 data,
                                       UNUSEDARG int64 mem_mask);
...
typedef struct address_map_t *(*construct_map_t)(void *, struct address_map_t *map);
...
union cpuinfo {
    ...
    void (*reset)(void *, void *param);                        /* CPUINFO_PTR_RESET */
    void (*exit)(void *);                                /* CPUINFO_PTR_EXIT */
    int (*execute)(void *, int cycles);                        /* CPUINFO_PTR_EXECUTE */
    void (*burn)(void *, int cycles);                        /* CPUINFO_PTR_BURN */
    offs_t (*disassemble)(void *, char *buffer, offs_t pc);    /* CPUINFO_PTR_DISASSEMBLE */
    int (*irqcallback)(void *, int state);                    /* CPUINFO_PTR_IRQCALLBACK */
