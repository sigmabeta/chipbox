...
Java_net_sigmabeta_chipbox_player_emulators_ssf_SsfEmulator_loadTrackInternal(
        JNIEnv *env,
        jobject thiz,
...
Java_net_sigmabeta_chipbox_player_emulators_ssf_SsfEmulator_generateBufferInternal(
        JNIEnv *env,
        jobject thiz,
...
JNIEXPORT void JNICALL
Java_net_sigmabeta_chipbox_player_emulators_ssf_SsfEmulator_teardownInternal(
        JNIEnv *env,
        jobject thiz
) {
    teardown();
...
Java_net_sigmabeta_chipbox_player_emulators_ssf_SsfEmulator_getLastError(
        JNIEnv *env,
        jobject thiz
) {
...
JNIEXPORT jint JNICALL
Java_net_sigmabeta_chipbox_player_emulators_ssf_SsfEmulator_getSampleRateInternal(
        JNIEnv *env,
        jobject thiz) {
