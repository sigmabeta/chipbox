...
Java_net_sigmabeta_chipbox_player_emulators_gme_GmeEmulator_generateBufferInternal(
        JNIEnv *env,
        jobject thiz,
...
JNIEXPORT void JNICALL
Java_net_sigmabeta_chipbox_player_emulators_gme_GmeEmulator_teardownInternal(
        JNIEnv *env,
        jobject thiz
) {
    teardown();
...
Java_net_sigmabeta_chipbox_player_emulators_gme_GmeEmulator_getLastError(
        JNIEnv *env,
        jobject thiz
) {
...
JNIEXPORT jint JNICALL
Java_net_sigmabeta_chipbox_player_emulators_gme_GmeEmulator_getSampleRateInternal(JNIEnv *env,
                                                                                  jobject thiz) {
