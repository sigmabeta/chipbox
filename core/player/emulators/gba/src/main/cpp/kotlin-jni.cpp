...
Java_net_sigmabeta_chipbox_player_emulators_gba_GbaEmulator_loadTrackInternal(
        JNIEnv *env,
...
Java_net_sigmabeta_chipbox_player_emulators_gba_GbaEmulator_generateBufferInternal(
        JNIEnv *env,
        jobject thiz,
...
JNIEXPORT void JNICALL
Java_net_sigmabeta_chipbox_player_emulators_gba_GbaEmulator_teardownInternal(
        JNIEnv *env,
        jobject thiz
) {
    teardown();
...
Java_net_sigmabeta_chipbox_player_emulators_gba_GbaEmulator_getLastError(
        JNIEnv *env,
        jobject thiz
) {
...
JNIEXPORT jint JNICALL
Java_net_sigmabeta_chipbox_player_emulators_gba_GbaEmulator_getSampleRateInternal(JNIEnv *env,
                                                                                  jobject thiz) {
