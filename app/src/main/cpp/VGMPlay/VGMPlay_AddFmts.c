        ...
        case 0x01:    // CMF File
            ...
            if (CMFHead.shtVersion == 0x0100) {
                ...
                CMFHead.shtTempo = (UINT16) (60.0 *
                                             CMFHead.shtTickspQuarter / CMFHead.shtTickspSecond +
                                             0.5);
            }
                                ...
                                switch (VGMData[VGMPos + 0x00]) {
                                    case 0x2F:
                                        if (CMFMaxLoop != 0x01) {
                                            ...
                                            VGMSmplPlayed -= SampleVGM2Playback(
                                                    VGMHead.lngLoopSamples);
                                            SmplPlayed = SamplePlayback2VGM(
                    ...
                    case 0xB0:
                        ...
                        switch (VGMData[VGMPos + 0x00]) {
                            ...
                            case 0x67:    // Rhythm Mode
                                if (!VGMData[VGMPos + 0x01]) {    // Set Rhythm Mode off
                                    DrumReg[0x00] = 0xC0;
                                    DrumReg[0x01] = 0xC0;
                                } else {    // Set Rhythm Mode on
                                    DrumReg[0x00] = 0xE0;
                                    DrumReg[0x01] = 0xE0;
                                }
                        ...
                        if (NoteOn) {
                            for (CurChip = 0x00; CurChip < 0x02; CurChip++) {
                                ...
                                if (!RhythmOn && TempByt != 0xFF) {
                                    ...
                                    chip_reg_write(0x09, CurChip, 0x00, 0xA0 | Channel,
                                                   TempSht & 0xFF);
                                    chip_reg_write(0x09, CurChip, 0x00, 0xB0 | Channel,
                                                   TempSht >> 8);
                                }
                            }
                        }
                    ...
                    case 0xC0:
                        ...
                        for (CurChip = 0x00; CurChip < 0x02; CurChip++) {
                            ...
                            if (OpMask & 0x01) {
                                ...
                                chip_reg_write(0x09, CurChip, 0x00,
                                               0x40 | (OpBase + 0x00),
                                               TempIns->ScaleLevel[TempByt]);
                                chip_reg_write(0x09, CurChip, 0x00,
                                               0x60 | (OpBase + 0x00),
                                               TempIns->AttackDelay[TempByt]);
                                chip_reg_write(0x09, CurChip, 0x00,
                                               0x80 | (OpBase + 0x00),
                                               TempIns->SustnRelease[TempByt]);
                                chip_reg_write(0x09, CurChip, 0x00,
                                               0xE0 | (OpBase + 0x00),
                                               TempIns->WaveSelect[TempByt]);
                                TempByt++;
                            }
                            if (OpMask & 0x02) {
                                // Write Operator 2
                            ...
                            chip_reg_write(0x09, CurChip, 0x00, 0xC0 | Channel,
                                           TempIns->FeedbConnect);
                        }
                    ...
                    default:
                        ...
                        switch (DROInf.iHardwareType) {
                            case 0x00:    // OPL 2
                                ...
                                break;
                            case 0x01:
                                chip_reg_write(0x09, CurChip, 0x00, Command,
                                               VGMData[VGMPos + 0x01]);
                                break;
                            case 0x02:    // OPL 3
                                chip_reg_write(0x0C, 0x00, CurChip, Command,
                                               VGMData[VGMPos + 0x01]);
                                break;
                            default:
                                chip_reg_write(0x09, CurChip, 0x00, Command,
