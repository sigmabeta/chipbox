...
static const UINT32 wavemasks[8] = {0x1ff00, 0x1fe00, 0x1fc00, 0x1f800, 0x1f000, 0x1e000, 0x1c000,
                                    0x18000};
...
static void
es5503_halt_osc(ES5503Chip *chip, int onum, int type, UINT32 *accumulator, int resshift) {
...
void device_reset_es5503(UINT8 ChipID) {
    ...
    chip->output_rate = (chip->clock / 8) /
                        (2 + chip->oscsenabled);    // (input clock / 8) / # of oscs. enabled + 2
