...
void FM_OPL_Reset(void) {
    ...
    for (i = 0; i < 3; i++) {
        Sound_OPL_Write(0x20 + i, 0x01);
        Sound_OPL_Write(0x23 + i, 0x01);
        Sound_OPL_Write(0x40 + i, 0x3f);
        Sound_OPL_Write(0x43 + i, 0x3f);
        Sound_OPL_Write(0x60 + i, 0xf0);
        Sound_OPL_Write(0x63 + i, 0xf0);
        Sound_OPL_Write(0x80 + i, 0xff);
        Sound_OPL_Write(0x83 + i, 0xff);
        Sound_OPL_Write(0xc0 + i, 0x00 | 0x30);

        Sound_OPL_Write(0x28 + i, 0x01);
        Sound_OPL_Write(0x2b + i, 0x01);
        Sound_OPL_Write(0x48 + i, 0x3f);
        Sound_OPL_Write(0x4b + i, 0x3f);
        Sound_OPL_Write(0x68 + i, 0xf0);
        Sound_OPL_Write(0x6b + i, 0xf0);
        Sound_OPL_Write(0x88 + i, 0xff);
        Sound_OPL_Write(0x8b + i, 0xff);
        Sound_OPL_Write(0xc3 + i, 0x00 | 0x30);

        Sound_OPL_Write(0x30 + i, 0x21);
        Sound_OPL_Write(0x33 + i, 0x21);
        Sound_OPL_Write(0x50 + i, 0x3f);
        Sound_OPL_Write(0x53 + i, 0x3f);
        Sound_OPL_Write(0x70 + i, 0xf0);
        Sound_OPL_Write(0x73 + i, 0xf0);
        Sound_OPL_Write(0x90 + i, 0xf0);
        Sound_OPL_Write(0x93 + i, 0xf0);
...
void FM_OPL_Write(int R, int V) {
        ...
        case 0x0e:
            ...
            if (FM_OPL_Rhythm_Mode) {
                ...
                if ((Previous_Register & 0x20) == 0x00) {
                    for (c = 0; c < 3; c++) {
                        Sound_OPL_Write(0xf0 + c, 0x00);
                        Sound_OPL_Write(0xf3 + c, 0x00);
                        Sound_OPL_Write(0xc6 + c, 0x00 | 0x30);
                    }
                    Sound_OPL_Write(0x70, 0xf0);
                    Sound_OPL_Write(0x73, 0xf0);
                    Sound_OPL_Write(0x71, 0xf0);
                    Sound_OPL_Write(0x74, 0xf0);
                    Sound_OPL_Write(0x72, 0xf0);
                    Sound_OPL_Write(0x75, 0xf0);

                    Sound_OPL_Write(0x30, 0x00);
                    Sound_OPL_Write(0x33, 0x01); /* bass */
                    Sound_OPL_Write(0x31, 0x01);
                    Sound_OPL_Write(0x34, 0x01); /* hi-hat/snare */
                    Sound_OPL_Write(0x32, 0x01);
                    Sound_OPL_Write(0x35, 0x01); /* tom/cymbal */

                    if (!(FM_OPL_Regs[0x26] & 0x20)) {
                        Sound_OPL_Write(0x90, 0x07);
                        Sound_OPL_Write(0x93, 0x07);
                    } else {
                        Sound_OPL_Write(0x90, 0x04);
                        Sound_OPL_Write(0x93, 0x04);
                    }
                    if (!(FM_OPL_Regs[0x27] & 0x20)) {
                        Sound_OPL_Write(0x91, 0x07);
                        Sound_OPL_Write(0x94, 0x07);
                    } else {
                        Sound_OPL_Write(0x91, 0x04);
                        Sound_OPL_Write(0x94, 0x04);
                    }
                    if (!(FM_OPL_Regs[0x28] & 0x20)) {
                        Sound_OPL_Write(0x92, 0x06);
                        Sound_OPL_Write(0x95, 0x06);
                    } else {
                        Sound_OPL_Write(0x92, 0x04);
                        Sound_OPL_Write(0x95, 0x04);
                    }
                    Sound_OPL_Write(0x50, 0x0f);
                    Sound_OPL_Write(0x53, fmVol[FM_OPL_Regs[0x36] & 0x0f] >> 1);
                    Sound_OPL_Write(0x51, fmVol[(FM_OPL_Regs[0x37] >> 4) & 0x0f]);
                    Sound_OPL_Write(0x54, fmVol[FM_OPL_Regs[0x37] & 0x0f]);
                    Sound_OPL_Write(0x52, fmVol[(FM_OPL_Regs[0x38] >> 4) & 0x0f]);
                    Sound_OPL_Write(0x55, fmVol[FM_OPL_Regs[0x38] & 0x0f]);

                    Sound_OPL_Write(0xa6, fref[6] & 0xff);
                    Sound_OPL_Write(0xb6, (fref[6] >> 8) & 0x1f);
                    Sound_OPL_Write(0xa7, fref[7] & 0xff);
                    Sound_OPL_Write(0xb7, (fref[7] >> 8) & 0x1f);
                    Sound_OPL_Write(0xa8, fref[8] & 0xff);
                    Sound_OPL_Write(0xb8, (fref[8] >> 8) & 0x1f);
                }
            }
    ...
    if (R >= 0x10 && R <= 0x28) {
        /**** Freq. set ****/
        F = R & 0x0f;
        Freq = (((int) FM_OPL_Regs[0x10 + F] & 0x00ff) |
                (((int) FM_OPL_Regs[0x20 + F] & 0x01) << 8)) << 1;
