...
#include <jni.h>
/* Header for class net_sigmabeta_chipbox_backend_gme_BackendImpl */

#ifndef _Included_net_sigmabeta_chipbox_backend_gme_BackendImpl
#define _Included_net_sigmabeta_chipbox_backend_gme_BackendImpl
#ifdef __cplusplus
extern "C" {
#endif
/*
