...
#include <jni.h>
/* Header for class net_sigmabeta_chipbox_backend_usf_BackendImpl */

#ifndef _Included_net_sigmabeta_chipbox_backend_usf_BackendImpl
#define _Included_net_sigmabeta_chipbox_backend_usf_BackendImpl
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     net_sigmabeta_chipbox_backend_usf_BackendImpl
 * Method:    loadFile
 ...
 * Signature: ([S)V
 */
JNIEXPORT void JNICALL Java_net_sigmabeta_chipbox_backend_usf_BackendImpl_readNextSamples
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_net_sigmabeta_chipbox_backend_usf_BackendImpl_getMillisPlayed
        (JNIEnv *, jobject);
